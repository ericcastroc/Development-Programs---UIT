...
public class Administrador extends Empregado {
    ...
    public double calcularSalario() {
        double salarioLiquido = super.calcularSalario() + this.ajudaDeCusto;
    ...
    public String toString() {
        return super.toString() + "Administrador [ajudaDeCusto=" + ajudaDeCusto + ", salarioLiquido="+ calcularSalario() +"]\n";
    }
