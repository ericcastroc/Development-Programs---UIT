...
public class Operario extends Empregado{
    ...
    public double calcularSalario() {
        double salarioLiquido = super.calcularSalario() + this.comissao;
		return salarioLiquido;
    }

    @Override
    public String toString() {
        return super.toString() + "Operario [comissao=" + comissao + ", valorProducao=" + valorProducao + ", salarioLiquido="+ calcularSalario() +", comissao="+ getComissao() +"]\n";
    }
