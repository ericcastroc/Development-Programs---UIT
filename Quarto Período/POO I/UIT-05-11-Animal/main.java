...
public class main {
    ...
    public static void main(String[] args){
        ...
        Mamifero camelo = new Mamifero("Camelo", 150 , 4 , "Amarelo" , "Terra" , 2, "brããã","");
        Peixe tubarao = new Peixe("Tubarão", 300 , 0 , "Cinzento" , "Mar" , 1.5 ,"glub glub","Barbatanas e cauda"); 
        Mamifero urso = new Mamifero("Urso-do-canadá", 180 , 4 , "Vermelho" , "Terra" , 0.5, "roar","Mel");
